  ...
  return (
    <html lang="zh-CN">
      ...
      <body>
        ...
        <footer>
          <div class="social">
            <a href="https://github.com/QuarterTime/DailyHotApi" className="link" target="_blank">
            ...
            <a href="https://quartertime.net" className="link" target="_blank">
              <svg
                className="btn-icon"
            ...
            <a href="mailto:quarter@quartertime.net" className="link">
              <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
                <path
                  fill="currentColor"
          ...
          <div class="power">
            Copyright&nbsp;©&nbsp;
            <a href="https://quartertime.net/" target="_blank">
              無名
            </a>
            &nbsp;|&nbsp;Power by&nbsp;
